                    ...
                    <div class="tab-pane" id="btabs{{ $language->name }}" role="tabpanel">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="country[{{ $language->lang }}]" class="form-control" placeholder="{{ __("backend.$routeNameData.country.*") }}">
                            </div>
                            <div class="form-group col-md-12">
                                <label>{{ __("backend.$routeNameData.company.*") }}</label>
                                <input type="text" name="company[{{ $language->lang }}]" class="form-control" placeholder="{{ __("backend.$routeNameData.company.*") }}">
                            </div>
                        </div>
                    </div>
                    @endforeach
                ...
                <div class="block-content tab-content">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <textarea class="form-control" name="phone" id="" cols="30" rows="10" placeholder="{{ __("backend.$routeNameData.phone") }}"></textarea>
                        </div>                                              
                        <div class="form-group col-md-6">
                            <label>{{ __("backend.$routeNameData.email") }}</label>
                            <textarea class="form-control" name="email" id="" cols="30" rows="10" placeholder="{{ __("backend.$routeNameData.email") }}"></textarea>
                        </div>                                              
                        <div class="form-group col-md-12">
