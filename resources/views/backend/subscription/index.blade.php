...
$(function() {
    ...
    var table = tableList.DataTable({
        ...
        columns: [
            ...
            { data: 'language.name', title: '語言', defaultContent: '' },
            { data: 'title', title: '標題', defaultContent: '' },
            {
                data: "status", title: '{{ __('status') }}',
                render: function ( data, type, row ) {   
                    switch (row.status) {
                        case 1:
                            return '<span class="text-success">發送完成</span>';
                            break;
                    
                        default:
                            return '<span class="text-danger">未發送</span>';
                            break;
                    }
                },
            ...
            { data: 'id', title: '{{ __('option') }}', bSortable: false, render:function(data,type,row) {
                return `<a class="edit" href="${ path }/${ data }">發信內容</a>`;
            }},
        ]
    });
