...
(function (factory) {
    ...
    $.extend($.summernote.plugins, {
      'imageAttributes': function (context) {
        ...
        this.initialize = function () {
          ...
          var body = '<ul class="nav nav-tabs" role="tablist" id="myTab">' +
                        '<li class="nav-item" role="presentation"><a class="nav-link active" data-toggle="tab" id="note-imageAttributes-' + i + '-tab" data-target="#note-imageAttributes-' + i + '" type="button" role="tab" aria-controls="note-imageAttributes-'+i+'" aria-selected="true">' + lang.imageAttributes.tabImage + '</a></li>' +
                        '<li class="nav-item" role="presentation"><a class="nav-link" data-toggle="tab" id="note-imageAttributes-attributes-' + i + '-tab" data-target="#note-imageAttributes-attributes-' + i + '" type="button" role="tab" aria-controls="note-imageAttributes-attributes-'+i+'" aria-selected="false">' + lang.imageAttributes.tabAttributes + '</a></li>' +
                        '<li class="nav-item" role="presentation"><a class="nav-link" data-toggle="tab" id="note-imageAttributes-link-' + i + '-tab" data-target="#note-imageAttributes-link-' + i + '" type="button" role="tab" aria-controls="note-imageAttributes-link-'+i+'" aria-selected="false">' + lang.imageAttributes.tabLink + '</a></li>';
          if (options.imageAttributes.disableUpload == false) {
             body +=    '<li class="nav-item" role="presentation"><a class="nav-link" data-toggle="tab" id="note-imageAttributes-upload-' + i + '-tab" data-target="#note-imageAttributes-upload-' + i + '" type="button" role="tab" aria-controls="note-imageAttributes-upload-'+i+'" aria-selected="false">' + lang.imageAttributes.tabUpload + '</a></li>';
          }
          body +=     '</ul>' +
                      '<div class="tab-content">' +
  // Tab 2
                      '<div class="tab-pane" id="note-imageAttributes-attributes-' + i + '" role="tabpanel" aria-labelledby="note-imageAttributes-attributes-' + i + '-tab">' +
                      ...
                      '</div>' +
  // Tab 3
                      '<div class="tab-pane" id="note-imageAttributes-link-' + i + '" role="tabpanel" aria-labelledby="note-imageAttributes-link-' + i + '-tab">' +
        ...
        if (options.imageAttributes.disableUpload == false) {
  // Tab 4
          body +=     '<div class="tab-pane" id="note-imageAttributes-upload-' + i + '" role="tabpanel" aria-labelledby="note-imageAttributes-upload-' + i + '-tab">' +
  ...
  // Tab 1
          body +=     '<div class="tab-pane fade in show active" id="note-imageAttributes-' + i + '" role="tabpanel" aria-labelledby="note-imageAttributes-' + i + '-tab">' +
